...
export class ThresholdsController {
  @Get()
  @ApiOperation({ summary: 'Get current alert thresholds for Ecuador' })
  ...
  @Put()
  @ApiOperation({ summary: 'Update alert thresholds for Ecuador' })
  ...
  @Post('reset')
  @ApiOperation({ summary: 'Reset alert thresholds to defaults for Ecuador' })
