...
class TemperatureThresholdsDto {
  @ApiProperty({ description: 'Température minimale acceptable', example: 26 })
  @IsNumber()
  @Min(-20)
  @Max(60)
  min: number;

  @ApiProperty({ description: 'Température maximale acceptable', example: 32 })
  @IsNumber()
  @Min(-20)
  @Max(60)
  max: number;
...
class HumidityThresholdsDto {
  @ApiProperty({ description: 'Humidité minimale acceptable', example: 53 })
  @IsNumber()
  @Min(0)
  @Max(100)
  min: number;

  @ApiProperty({ description: 'Humidité maximale acceptable', example: 57 })
  @IsNumber()
  @Min(0)
  @Max(100)
  max: number;
