...
export class ThresholdsController {
  @Get()
  @ApiOperation({ summary: 'Get current alert thresholds for Colombia' })
  ...
  @Put()
  @ApiOperation({ summary: 'Update alert thresholds for Colombia' })
  ...
  @Post('reset')
  @ApiOperation({ summary: 'Reset alert thresholds to defaults for Colombia' })
